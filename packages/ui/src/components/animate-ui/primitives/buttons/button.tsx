/**
 * @module @acp-website/ui/components/animate-ui/primitives/buttons/button
 ...
 * @acp:summary "Props for the animated Button primitive component. Extends Framer Motion"
 */
