/**
 * @module @acp-website/ui/components/animate-ui/primitives/animate/code-block
 ...
 * @acp:summary "Props for the CodeBlock primitive component. Combines div props with code"
 */
 ...
 * animation.
 *
 * @acp:summary "Animated CodeBlock primitive with syntax highlighting and typewriter effect."
 * @acp:summary "Animated CodeBlock primitive with syntax highlighting and typewriter effect."
 * @example
 *   ```tsx
 *   // Static code display
...
function CodeBlock({
  ...
  React.useEffect(() => {
    ...
    /**
     * @acp:summary "Loads highlighted code"
     */
  ...
  React.useEffect(() => {
    ...
    /**
     * @acp:summary "Completes animation"
     */
