/**
 * @module @acp-website/ui/components/animate-ui/primitives/animate/slot
 ...
 * @acp:summary "Generic props type for any object with unknown values. Used for flexible prop"
 */
 ...
 *
 * @acp:summary "Motion-enabled DOM props for HTML elements. Extends Framer Motion's"
 ...
 *
 * @acp:summary "Utility type for components supporting the asChild composition pattern. When"
 * @example
 *   ```tsx
 ...
 * @acp:summary "Props for the Slot component."
 */
 ...
 *
 * @acp:lock restricted
 * @acp:summary "Merges multiple React refs into a single ref callback. Handles both callback"
 ...
 *
 * @acp:lock restricted
 * @acp:summary "Merges props from child element and slot component. Handles special merging"
 * @template T - The HTML element type
 ...
 *
 * @acp:lock restricted
 * @acp:summary "Helper function to get or create a motion component for a given type. Uses"
