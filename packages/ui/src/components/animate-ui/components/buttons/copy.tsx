/**
 * @module @acp-website/ui/components/animate-ui/components/buttons/copy
 ...
 * @acp:summary "Props for the CopyButton component. Extends the animated Button primitive"
 */
