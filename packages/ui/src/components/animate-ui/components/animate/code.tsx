/**
 * @module @acp-website/ui/components/animate-ui/components/animate/code
 ...
 * @acp:summary "Hook to get the current theme, with fallback for environments without"
 *
 ...
 * @internal
 * @acp:lock restricted
 * @acp:summary "Context type for sharing code content between compound components."
 */
