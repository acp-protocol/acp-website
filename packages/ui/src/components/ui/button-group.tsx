/**
 * @module @acp-website/ui/components/ui/button-group
 ...
 *
 * @acp:summary "Button group container component."
 * @acp:summary "Button group container component."
 * @example
 *   ```tsx
 ...
 *
 * @acp:summary "Button group text label component."
 * @example
 *   ```tsx
 *   // Standard text label
 ...
 * layout.
 * @acp:summary "Button group separator component."
 *
 * @example
 *   ```tsx
 *   <ButtonGroup>
