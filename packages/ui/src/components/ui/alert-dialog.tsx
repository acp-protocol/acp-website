/**
 * @module @acp-website/ui/components/ui/alert-dialog
 ...
 *
 * @acp:summary "Root component for the AlertDialog."
 * @acp:summary "Root component for the AlertDialog."
 * @example
 *   ```tsx
 *   <AlertDialog>
 ...
 * @acp:summary "Trigger button that opens the AlertDialog."
 *
 ...
 * @acp:summary "Portal container for rendering AlertDialog outside the DOM hierarchy."
 *
 ...
 * @acp:summary "Semi-transparent overlay behind the AlertDialog."
 *
 ...
 * @acp:summary "Main content container for the AlertDialog."
 *
 * @example
 *   ```tsx
 *   <AlertDialogContent>
 ...
 * @acp:summary "Header container for AlertDialog title and description."
 *
 ...
 * @acp:summary "Description component for the AlertDialog."
 *
 ...
 *
 * @acp:summary "Primary action button for the AlertDialog."
 * @example
 *   ```tsx
 ...
 *
 * @acp:summary "Cancel button for the AlertDialog."
 * @example
 *   ```tsx
 *   <AlertDialogCancel>Cancel</AlertDialogCancel>
 *   ```;
