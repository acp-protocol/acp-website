 ...
 * @module @acp-website/ui/components/ui/accordion
 */
 ...
 * @acp:summary "Root component for the Accordion."
 * @acp:summary "Root component for the Accordion."
 ...
 *
 * @acp:summary "Individual accordion item container."
 ...
 * @acp:summary "Clickable trigger that expands/collapses accordion content."
 *
