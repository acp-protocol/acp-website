/**
 * @module @acp-website/ui/components/ui/avatar
 ...
 * @acp:summary "Root Avatar container component."
 *
 * @example
 *   ```tsx
 *   <Avatar>
 ...
 *
 * @acp:summary "Avatar image component that displays the user's avatar image."
 * @example
 *   ```tsx
 ...
 *
 * @acp:summary "Avatar fallback component displayed when image fails to load."
 * @acp:summary "Avatar fallback component displayed when image fails to load."
 * @example
 *   ```tsx
 *   <AvatarFallback>JD</AvatarFallback>
