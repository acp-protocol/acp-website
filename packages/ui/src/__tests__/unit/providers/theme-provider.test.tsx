 ...
 * @acp:domain testing
 * @acp:summary "Helper component for testing useTheme hook behavior."
 */
...
describe("ThemeProvider", () => {
  ...
  describe("Performance Tests", () => {
    it("does not cause excessive re-renders on theme switch", async () => {
       ...
       * @acp:domain testing
       * @acp:summary "Tracks render count for performance testing."
       * @acp:domain testing
       * @acp:summary "Tracks render count for batching test."
       */
