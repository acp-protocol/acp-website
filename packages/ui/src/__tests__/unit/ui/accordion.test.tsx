...
import { raceConditionTester } from "@acp-website/test-utils";
 ...
 * @acp:domain tests
 * @acp:summary "Test helper component for accordion with configurable type."
...
describe("Accordion", () => {
  ...
  describe("Performance Tests", () => {
    it("does not re-render excessively", async () => {
       ...
       * @acp:domain testing
       * @acp:summary "Tracks render count for accordion performance testing."
       */
  ...
  describe("Chaos Tests", () => {
    ...
    it("handles controlled value changes", async () => {
       ...
       * @acp:domain testing
       * @acp:summary "Controlled accordion for testing external state management."
       */
