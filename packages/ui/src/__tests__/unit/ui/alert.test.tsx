...
import { rapidFire, raceConditionTester } from "@acp-website/test-utils";
...
describe("Alert", () => {
  ...
  describe("Performance Tests", () => {
    it("does not re-render excessively on parent re-render", () => {
       ...
       * @acp:domain testing
       * @acp:summary "Tracks render count for Alert performance testing."
       * @acp:domain testing
       * @acp:summary "Tracks render count for variant change testing."
       */
